...
class SmallAdmobNativeAdView : FrameLayout {
    ...
    fun setButtonData(jsonObject: JSONObject) {
        ...
        if (!jsonObject.optBoolean("is_default", true)) {
            ...
            ll_back.setStroke(
                10, Color.parseColor(jsonObject.optString("border_color", "#3F3F3F"))
            )
    ...
    fun setNativeAd(nativeAd: NativeAd) {
        ...
        if (nativeAd.price != null) {
            ...
            if (nativeAd.price == "0") adPrice.visibility = GONE
        } else {
    ...
    private fun initView(context: Context, attributeSet: AttributeSet?) {
        ...
        inflater.inflate(R.layout.ad_admob_small_native, this)
    }
