...
import com.R
import com.advs.AdmobNativeAdAdapter
import com.advs.AdmobNativeAdView
import com.advs.CustomBannerAdView
import com.advs.CustomNativeAdView
import com.advs.FacebookNativeAdView
import com.advs.SmallAdmobNativeAdView
import com.dialogs.RewardedAdsDialog
    ...
    private fun showAdmobNative(
        ...
        val builder =
            com.google.android.gms.ads.AdLoader.Builder(context, adTag).forNativeAd { nativeAd ->
                val template: AdmobNativeAdView =
...
//    Small Native Ads Start
    ...
    fun showAdmobSmallNative(
        ...
        val builder =
            com.google.android.gms.ads.AdLoader.Builder(context, adTag).forNativeAd { nativeAd ->
                val template: SmallAdmobNativeAdView =
                    nativeAdView.findViewById(R.id.my_template)
                template.setButtonData(getData.getNativeBtnConfig())
                template.setNativeAd(nativeAd)
            }.withAdListener(object : com.google.android.gms.ads.AdListener() {
